        ...
        <RevealOnScroll>
          <div className="rounded-[2rem] border border-white/20 bg-white/15 p-8 text-center backdrop-blur-xl">
            ...
            <p className="mx-auto max-w-3xl text-lg leading-9 text-white/85">
              Sometimes a thought does not need to become content. Sometimes it
              just needs to leave your head. Quietli is a calm little place for
              those thoughts: poetic ones, dumb ones, funny ones, mundane ones,
              and private-feeling ones you still want to put somewhere.
            </p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <RevealOnScroll delay={220}>
            <div className="rounded-[2rem] border border-white/20 bg-white/15 p-6 backdrop-blur-xl">
              ...
              <p className="text-sm leading-6 text-white/75">
                Use it like a mental exhale, a note to yourself, or a tiny poem
        ...
        <RevealOnScroll>
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-white/80">
              Choose a color mood, add a profile picture, write a tiny bio, and
              let your blips carry a visual tone that feels personal.
            </p>
          </div>
        </RevealOnScroll>
        ...
        <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-[2rem] border border-white/20 bg-white/15 p-5 backdrop-blur-xl">
              ...
              >
                <p className="text-sm font-bold text-[#2b0f2f]">
                  Today I remembered that being quiet is not the same as having
                  nothing to say.
                </p>
              </div>
            </div>
          ...
          <RevealOnScroll delay={340}>
            <div className="rounded-[2rem] border border-white/20 bg-white/15 p-5 backdrop-blur-xl">
              ...
              <p className="mt-5 text-sm leading-6 text-white/75">
                Your page can feel designed, personal, and calm without being a
                performance.
              </p>
            </div>
          </RevealOnScroll>
          ...
          <div className="grid gap-6 rounded-[2rem] border border-white/20 bg-white/15 p-8 backdrop-blur-xl md:grid-cols-[1fr_1.1fr]">
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-white/80">
                ...
                drift onto a homepage, sidebar, footer, or personal site without
                needing another social feed.
              </p>
            </div>
