...
export function EmbedCodeBox({ username }: EmbedCodeBoxProps) {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden rounded-[1.5rem] border border-white/20 bg-white/20 p-4 text-white backdrop-blur-xl sm:p-6">
      ...
      <div className="mt-5 w-full max-w-full overflow-hidden rounded-[1.5rem] border border-white/15 bg-white/15 p-4">
        ...
        <div className="mt-5">
          ...
          <div className="w-full max-w-full overflow-hidden rounded-[1.5rem] border border-white/25 bg-white/20 p-2">
            <div
              className="w-full max-w-full overflow-hidden rounded-[1.25rem] bg-white/10"
              style={{
                height: activeHeight,
